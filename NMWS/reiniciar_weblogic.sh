...
if [ $user == faq1 ]; then
    ...
    cd /soa/fqa1/user_projects/domains/IB_FQA1_DOM && ./startNodeManager.sh && ./startWebLogic.sh
elif [ $user == uat2 ]; then
    #WLI UAT2
    ...
    cd /appl/uat2/domains/wli_uat2_domain && ./startNodeManager.sh && ./startWebLogic.sh
else
